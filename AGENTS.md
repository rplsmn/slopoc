1) Create a new folder for your work with an appropriate name.

2) Create `agent-notes.md` file in that folder and append notes to it as you work, tracking what you tried and anything you learned along the way.

3) Build a `README.md` report at the end of the session.

Your final commit should include just that folder and selected items from its contents:

- The `agent-notes.md` and `README.md` files
